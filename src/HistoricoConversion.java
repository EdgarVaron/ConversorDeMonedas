...
public class HistoricoConversion {
    ...
    public HistoricoConversion(String monedaBase, String monedaObjetivo, double cantidadACambiar, double cantidadEnMonedaObjetivo) {
